...
public class PopularRecommendTest {
	...
	public static void main(String[] args) {
		...
		Rating [] rate= {r0,r2,r3,r4,r5,r6,r7,r8};
		...
		Movie movieTest3=new Movie("2,Jumanji (1995),Adventure|Children|Fantasy");
		Movie movieTest9=new Movie("70,From Dusk Till Dawn (1996),Action|Comedy|Horror|Thriller");
		Movie movieTest5=new Movie("135,Down Periscope (1996),Comedy");
		Movie movieTest6=new Movie("27,Now and Then%2C (1995),Children|Drama");
		Movie movieTest7=new Movie("15,Cutthroat Island (1995),Action|Adventure|Romance");
		Movie [] mv1= {movieTest5,movieTest2,movieTest,movieTest9,movieTest3,movieTest0,movieTest1,movieTest6,movieTest7,movieTest9};
		 ...
		 Movie [] xx=test.recommendBeta("9",6);
		 ...
		 System.out.println();
		Movie[] recommendTest= (test.recommendOne("27","Comedy"));
