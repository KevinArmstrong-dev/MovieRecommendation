 ...
 *         class. It uses an example provided in the instructions for phase 1.
 */
public class MovieTest {
	...
	/**
	 * @param movieTest Test if the name attribute from the Movie class is properly
	 *                  initiated. Prints Success if it works and prints fail if it
	 *                  doesn't,
	 */
